...
import hensal.spellpackblood.registry.BookshelfItems;
import hensal.spellpackblood.registry.MySpellPackLoot;
...
public class MySpellPack
{
    ...
    public static final String MODID = "spellpackblood";
    ...
    @SidedProxy(clientSide = "hensal.spellpackblood.client.ClientProxy", serverSide = "hensal.spellpackblood.CommonProxy")
